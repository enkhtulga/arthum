...
class QpayController extends Controller
{
    ...
    {
        $this->clientId = env('QPAY_CLIENT_ID');
        $this->clientSecret = env('QPAY_CLIENT_SECRET');
    ...
    public function payment()
    {
        ...
        return view('frontend/qpay/payment', ['response' => $responseData]);
    }

    public function paymentSpp()
    {
        $responseData = Session::get('qpay_response');
        return view('seller_packages/frontend/qpay_payment', ['response' => $responseData]);
    }
